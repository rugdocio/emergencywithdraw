...
const customizeRenderEmpty = () => (
  <div style={{ textAlign: 'center' }}>
    ...
    <p>Make sure that you're connected to the correct network (Supported: BSC, Polygon, Avalanche, Fantom, Cronos, IOTEX, Moonriver, Celo, Harmony ONE, KCC, okex and Moonbeam)</p>
    <p></p>
